...
/*Customization{{{*/
const TString XGT2_DIR="/work/halla/e08014/disk1/yez/Gen_XS_Table/Plot/"; //this is for inputfiles,outfiles,logfiles
...
//const TString ROOTFILES_DIR="/work/halla/e08014/disk1/Rootfiles_20130128"; //this is for rootfiles
const TString ROOTFILES_NAME = "e08014"; //such as e08014_4299.root
const TString DATAQUALITYFILES_DIR="/work/halla/e08014/disk1/yez/Ep_Cross_Section/";//this is for dataqualityfiles
const TString SAMCFILES_DIR="/work/halla/e08014/disk1/yez/Monte_Calo/SAMC/rootfiles/";    //this is for SAMC Rootfiles
const TString XEMC_Table_Path="/work/halla/e08014/disk1/yez/Gen_XS_Table/Plot/"; 
bool bXEMC_Model_New=kTRUE;
//bool bXEMC_Model_New=kFALSE;
//If kFALSE use the old cross section model int the sub-directory
