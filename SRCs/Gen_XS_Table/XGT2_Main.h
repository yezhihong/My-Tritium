...
//All Energy Unit are in MeV, all Length Units are in cm!
  ...
  //const TString ROOTFILES_DIR="/work/halla/e08014/disk1/Rootfiles_short";     //this is for rootfiles
  ...
  //const TString XEMC_Table_Path = "/work/halla/e08014/disk1/yez/Monte_Calo/Cross_Section_Tables/0920/";
  ofstream outlog; 
...
inline double gGet_Target_Mass_A(const TString& aTarget_Name){
	...
	mass = 0.938272; //don't use the average-nucleon-mass to define xbj
